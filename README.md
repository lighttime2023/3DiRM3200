...
The codes of R2Net for training and testing are in the folder "R2Net" as the Jupyter Notebooks "R2Net-In.ipynb", "R2Net-Out.ipynb" and "R2Net-Outlite.ipynb" with the corresponding results. Due to the size limitation of upload data on the github, the trained models of R2Net-In and R2Net-Out cannot be uploaded, which are also available by contacting me at huiting_rao@tongji.edu.cn.
